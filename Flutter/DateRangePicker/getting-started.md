...
## Today button
Display the today button at the bottom of the date range picker. When the button is clicked, the view easily moves to the current date of the picker view.
