...
* [How to add recurring appointments until the specified date in the Flutter event calendar (SfCalendar)](https://support.syncfusion.com/kb/article/10721/how-to-add-recurring-flutter-calendar-appointments-in-specified-date)
* [How to add the appointments to the Fire base database using appointment editor in the Flutter event calendar (SfCalendar)](https://support.syncfusion.com/kb/article/10541/how-to-add-the-appointments-to-the-firebase-database-using-appointment-editor-in-the-flutter-calendar)
* [How to work with the Fire base database and the Flutter event calendar (SfCalendar) for appointments](https://support.syncfusion.com/kb/article/10404/how-to-work-on-firebase-database-in-flutter-calendar-for-appointment)
* [How to add google calendar events to the Flutter event calendar (SfCalendar)](https://support.syncfusion.com/kb/article/10505/how-to-add-google-calendar-events-to-the-flutter-event-calendar)
...
* [How to get the recurrence date collection in the Flutter event calendar (SfCalendar)](https://support.syncfusion.com/kb/article/10820/how-to-get-the-recurrence-date-collection-in-flutter-calendar)
...
* [How to add the appointments to Fire store Database using Flutter Calendar](https://support.syncfusion.com/kb/article/11077/how-to-add-appointments-to-firestore-database-using-flutter-calendar)
