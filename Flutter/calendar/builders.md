...
By using the [appointmentBuilder](https://pub.dev/documentation/syncfusion_flutter_calendar/latest/calendar/SfCalendar/appointmentBuilder.html) date property we can identify the appointment view start date. For example, in the month view, we have spanned appointment(StartTime - August 17,2022 and EndTime - August 30,2022) and the appointment renders with 3 views, the `appointmentBuilder` date property holds the start date (August 17,2022, August 21,2022 and August 28,2022) of each appointment view. Please [click here]() to view the sample.
