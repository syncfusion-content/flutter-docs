...
* You can`t get the controller.view by using `onTap` and `onLongPress` callbacks for allowed views.
* `onTap` and `onLongPress` callbacks not applicable for date selection of the picker in the calendar header.
