...
1. Navigate to the [example](https://pub.dev/packages/syncfusion_flutter_calendar/example) tab on [pub.dev](https://pub.dev/), and scroll down to find the widget code.
