...
description: You can learn here all about adding Syncfusion Flutter Calendar (SfCalendar) widget in FlutterFlow framework.
platform: flutter
control: SfCalendar
documentation: ug
---
...
1. Visit [pub.dev](https://pub.dev/) and search for the [Syncfusion Flutter Calendar](https://pub.dev/packages/syncfusion_flutter_calendar) dependency using the search bar.
...
1. To find the package to copy, scroll down from the [installing](https://pub.dev/packages/syncfusion_flutter_calendar/install) tab on [pub.dev](https://pub.dev/) as shown in the snapshot.
...
1. Navigate to the **Syncfusion Calendar Documentation** at [help.syncfusion.com](https://help.syncfusion.com/flutter/calendar/getting-started) and scroll down to find the widget codes.
