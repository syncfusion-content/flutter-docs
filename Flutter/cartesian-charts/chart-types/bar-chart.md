...
* [Create horizontal bar chart](https://support.syncfusion.com/kb/article/10822/how-to-create-horizontal-bar-chart-in-flutter-using-cartesian-charts-widget-sfcartesianchart-).
