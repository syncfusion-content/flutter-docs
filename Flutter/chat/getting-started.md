...
description: Learn here about getting started with Syncfusion Essential Studio Chat widget, its elements, and more.
platform: flutter
control: SfChat
documentation: ug
---
...
![Default chat in vue chat.](images/getting-started/initialize-chat.png)
...
![Placeholder to composer in vue chart.](images/getting-started/placeholder-to-composer.png)
...
![Getting started with placeholder in vue chat.](images/getting-started/placeholder-to-composer.png)
...
![Getting started with action button in vue chat.](images/getting-started/actionbutton-in-vue-chat.png)
