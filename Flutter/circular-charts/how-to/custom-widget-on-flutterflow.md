...
2. Navigate to [Syncfusion<sup>&reg;</sup> Flutter Charts](https://pub.dev/packages/syncfusion_flutter_charts) on [pub.dev](https://pub.dev/) and copy the dependency name and version using the `Copy to Clipboard` option.
...
>**Note**: Since [Syncfusion<sup>&reg;</sup> Flutter Charts](https://pub.dev/packages/syncfusion_flutter_charts) depends on the [Syncfusion<sup>&reg;</sup> Flutter Core](https://pub.dev/packages/syncfusion_flutter_core) package, make sure to add it as a dependency by following the same steps mentioned above.
