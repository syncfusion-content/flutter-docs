---
layout: post
title: Column types in Flutter DataGrid | DataTable | Syncfusion
description: Learn here all about how to add columns types in Syncfusion Flutter DataGrid control, its elements and more.
platform: flutter
control: SfDataGrid
documentation: ug
---
