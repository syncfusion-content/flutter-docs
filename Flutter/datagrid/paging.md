...
**NOTE**  
  * You can view dropdown button option by horizontally scrolling the DataPager.

  * Dropdown button option is not supported if the [direction](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataPager/direction.html) is vertical.
