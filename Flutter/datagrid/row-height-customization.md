...
>**NOTE**
   By default, the header text’s overflow behavior is ellipsis. So, to enable the wrap for the display text, set the headerTextSoftWrap property as true andheaderTextOverflow` property as clip.
