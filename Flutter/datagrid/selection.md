...
When using `multiple`, you can select multiple rows by pressing the key modifiers <kbd>Shift</kbd> + <kbd>Down</kbd> and <kbd>Shift</kbd> + <kbd>Up</kbd>.
...
You can select rows programmatically by setting the `DataGridController.selectedIndex`, `DataGridController.selectedRow`, or `DataGridController.selectedRows` property based on the selection mode.  

When the selection mode is `single`, you can select a row programmatically in two ways: by setting the row index to the `DataGridController.selectedIndex` property, or by setting the `DataGridRow` to be selected to the `DataGridController.selectedRow` property.
...
<td>
If the current cell is in edit mode, call the <a href= "https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/DataGridSource/onCellCancelEdit.html" aria-label="DataGridSource onCellCancelEdit method">DataGridSource.onCellCancelEdit </a> method to revert the current changes and ends the editing.
</td>
</tr>
</table>
 ...
 * `onSelectionChanging` : This callback is raised before a row is selected at execution time, allowing you to cancel the selection action by returning `false`.
 * `onSelectionChanged` : This callback is raised after the row is successfully selected.
 ...
 * newItems: Gets a collection of the `DataGridRow` objects added to the selection.
 * oldItems: Gets a collection of the `DataGridRow` objects removed from the selection.
 ...
 * newRowColumnIndex: Gets the current [RowColumnIndex](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/RowColumnIndex-class.html) of the current cell, containing row and column indices.
 * oldRowColumnIndex: Gets the previous [RowColumnIndex](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/RowColumnIndex-class.html) of the current cell, containing row and column indices.
...
The Datagrid provides the following callbacks to handle interactions with the cells. These callbacks are triggered after [onSelectionChanging](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/onSelectionChanging.html) and [onSelectionChanged](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/onSelectionChanged.html) callbacks.

* [onCellTap](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/onCellTap.html) : Called when a tap on a cell has occurred.
* [onCellDoubleTap](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/onCellDoubleTap.html) : Called when a cell is tapped with a primary button twice in quick succession.
...
* [onCellSecondaryTap](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/onCellSecondaryTap.html) : Called when a tap on a cell has occurred with a secondary button.
...
Customize the selection background color using the [selectionColor](https://pub.dev/documentation/syncfusion_flutter_core/latest/theme/SfDataGridThemeData/selectionColor.html) property of the [SfDataGridThemeData](https://pub.dev/documentation/syncfusion_flutter_core/latest/theme/SfDataGridThemeData-class.html).
...
Customize the current cell border color and thickness using the [currentCellStyle](https://pub.dev/documentation/syncfusion_flutter_core/latest/theme/SfDataGridThemeData/currentCellStyle.html) property of [SfDataGridThemeData](https://pub.dev/documentation/syncfusion_flutter_core/latest/theme/SfDataGridThemeData-class.html). The current cell border is displayed when [navigationMode](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/SfDataGrid/navigationMode.html) is set to [GridNavigationMode.cell](https://pub.dev/documentation/syncfusion_flutter_datagrid/latest/datagrid/GridNavigationMode.html).
