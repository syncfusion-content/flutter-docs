...
Funnel chart supports right to left rendering. But series and other chart elements rendering will be the same for both LTR and RTL. Legend and tooltip rendering will be changed.
...
![legend RTL](images/rtl-support/funnel_legend.jpg)
...
![Tooltip RTL](images/rtl-support/funnel_tooltip.jpg)
