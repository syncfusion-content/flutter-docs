...
description: Learn here how to download the Syncfusion Flutter Mac installer packages from the Syncfusion website.
platform: flutter
...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio<sup>&reg;</sup> Flutter Offline trial installer. Select Mac OS as the platform. The installer is available in DMG format.
...
4. Only DMG format is available for Mac.
