---
layout: post
title: Installing Syncfusion Flutter web installer - Syncfusion
description: Learn here about how to install Syncfusion Flutter web installer after downloading from our Syncfusion website.
platform: flutter
...
# Installing Syncfusion Flutter Web Installer


## Overview

For the Essential Studio&reg; Flutter product, Syncfusion offers a Web Installer. This installer alleviates the burden of downloading a larger installer. You can simply download and run the online installer, which will be smaller in size and will download and install the Essential Studio&reg; products you have chosen. You can get the most recent version of Essential Studio&reg; Web Installer [here](https://www.syncfusion.com/account/downloads).
 
## Installation

The steps below show how to install Essential Studio&reg; Flutter Web Installer.

1.  Open the Syncfusion Essential Studio&reg; Flutter Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
Follow either one of the option below to uninstall Syncfusion Essential Studio&reg; Flutter installer.
...
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio&reg; {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall Flutter alone by selecting the **Syncfusion Essential Studio&reg; for Flutter {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](images/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio&reg; for Flutter {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio&reg; Flutter alone will be removed and the below default MSI uninstallation window will be displayed.	
