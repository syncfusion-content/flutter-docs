...
description: Learn here all about the UI customization options in Syncfusion Flutter PDF Viewer widget (SfPdfViewer) and more.
platform: flutter
control: SfPdfViewer
documentation: ug
---
...
This section walks you through the UI customization options supported in the [SfPdfViewer](https://pub.dev/documentation/syncfusion_flutter_pdfviewer/latest/pdfviewer/SfPdfViewer-class.html).
