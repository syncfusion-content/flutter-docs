...
description: Learn how to draw text, apply text directions and usages of different fonts in the Flutter PDF.
platform: flutter
control: PDF
documentation: ug
---
...
The Syncfusion Flutter PDF provides support to draw a CJK (Chinese, Japanese, Korean) text using some of the standard CJK fonts. The font data can be initialized by initializing PdfFont class as PdfCjkStandardFont class. The following code sample explains this.
