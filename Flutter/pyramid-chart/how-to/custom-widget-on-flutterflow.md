...
description: Learn here all about adding Syncfusion Pyramid Chart widget in FlutterFlow.
platform: flutter
control: Chart
documentation: ug
---

# How to add Syncfusion Pyramid Chart widget in FlutterFlow?
...
### Add Pyramid Chart widget as a dependency
