...
* **Animation** - The radial gauge animates all of its elements during initial loading and provides visually appealing animations when pointers move from one value to another. The animation duration can be customized to suit your application's needs. See the [animation](animation.md) documentation to learn more.
