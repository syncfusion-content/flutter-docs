...
description: This section explains about the steps required to add the range selector widget and its elements such as numeric and date values, ticks, labels and tooltips in Flutter application. 
platform: Flutter
