...
This section explains how to set intervals for numeric and date range sliders.
...
You can select a particular interval by tapping when setting the [`enableIntervalSelection`](https://pub.dev/documentation/syncfusion_flutter_sliders/latest/sliders/SfRangeSlider/enableIntervalSelection.html) property to `true`. Both the thumbs will be moved to the current interval with animation.
