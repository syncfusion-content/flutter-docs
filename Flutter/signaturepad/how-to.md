---
layout: post
title: SignaturePad widget in FlutterFlow framework | Syncfusion
description: Learn here all about adding Syncfusion SignaturePad widget in 
...
# How to add Syncfusion Flutter SignaturePad widget in FlutterFlow framework?
...
1. Visit [pub.dev](https://pub.dev/) and search for the [Syncfusion Flutter SignaturePad](https://pub.dev/packages/syncfusion_flutter_signaturepad) dependency using the search bar.
...
1. To find the package to copy, scroll down from the [installing](https://pub.dev/packages/syncfusion_flutter_signaturepad/install) tab on [pub.dev](https://pub.dev/) as shown in the snapshot.
