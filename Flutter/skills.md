...
Install [Syncfusion<sup style="font-size:70%">&reg;</sup> Flutter widgets skills](https://github.com/syncfusion/flutter-widgets-skills.git) using the Skills CLI. Users can also explore available skills from the [marketplace](https://skills.sh/syncfusion/).
