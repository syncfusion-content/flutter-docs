---
layout: post
title: Treemap widget in FlutterFlow framework | Syncfusion
description: Learn here all about adding Syncfusion Treemap widget in 
...
# How to add Syncfusion Treemap widget in FlutterFlow framework?
...
1. Visit [pub.dev](https://pub.dev/) and search for the [Syncfusion Flutter Treemap](https://pub.dev/packages/syncfusion_flutter_treemap) dependency using the search bar.
...
1. To find the package to copy, scroll down from the [installing](https://pub.dev/packages/syncfusion_flutter_treemap/install) tab on [pub.dev](https://pub.dev/) as shown in the snapshot.
...
1. Navigate to the **Syncfusion Treemap Documentation** at [help.syncfusion.com](https://help.syncfusion.com/flutter/treemap/getting-started) and scroll down to find the widget codes.
